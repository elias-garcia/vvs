...
public class UserProfileDaoUnitTest {
	...
	private void initializeUser() {
		userProfile = new UserProfile(EXISTENT_LOGIN_NAME, "pass", "nombre", "apellido", "user@gmail.com");
	...
	public void testFindByLoginNameWithANonExistentName() throws InstanceNotFoundException {
		/* Setup */
		initializeUser();
		/* Call */
	 ...
	 */
	@Test
	public void testFindByLoginNameWithAExistentName() throws InstanceNotFoundException {
		/* Setup */
		initializeUser();
		/* Call */
