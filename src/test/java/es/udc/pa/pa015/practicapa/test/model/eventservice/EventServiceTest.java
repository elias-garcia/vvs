...
public class EventServiceTest {
  ...
  private void initializeEventInfos() {
    persistentEventInfos.add(new EventInfo(EXISTENT_EVENT_NAME0, getPastDate(),
        persistentCategoryInfos.get(0)));
    persistentEventInfos.add(new EventInfo(EXISTENT_EVENT_NAME1, getPastDate(),
        persistentCategoryInfos.get(1)));
    persistentEventInfos.add(new EventInfo(EXISTENT_EVENT_NAME2,
        getFutureDate(), persistentCategoryInfos.get(0)));
    persistentEventInfos.add(new EventInfo(EXISTENT_EVENT_NAME3,
        getFutureDate(), persistentCategoryInfos.get(1)));
  ...
  public void testCreateAndFindEvent() throws InstanceNotFoundException,
    ...
    /* Call */
    EventInfo event = eventService.createEvent(EXISTENT_EVENT_NAME2,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId());
  ...
  public void testCreateEventWithNullName() throws InstanceNotFoundException,
    ...
    /* Call */
    eventService.createEvent(null, getFutureDate(), persistentCategoryInfos.get(
        0).getCategoryId());
  ...
  public void testCreateEventWithNullDate() throws InstanceNotFoundException,
    ...
    /* Call */
    eventService.createEvent(EXISTENT_EVENT_NAME0, null, persistentCategoryInfos
        .get(0).getCategoryId());
  ...
  public void testCreateEventWithPastDate() throws InstanceNotFoundException,
    ...
    /* Call */
    eventService.createEvent(EXISTENT_EVENT_NAME0, getPastDate(),
  ...
  public void testFindEventById() throws InstanceNotFoundException {
    ...
    /* Call */
    EventInfo event = eventService.findEvent(persistentEventInfos.get(0)
        .getEventId());
  ...
  public void findEventsFilteringWithStartIndexAndCount1()
    ...
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME0,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId()));
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME1,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId()));
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME2,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId()));
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME3,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId()));
    /* Call */
    EventInfoBlock eventInfoBlock = eventService.findEvents(null,
        persistentCategoryInfos.get(0).getCategoryId(), true, 0, 3);
  ...
  public void findEventsFilteringWithStartIndexAndCount2()
    ...
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME0,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId()));
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME1,
        getFutureDate(), persistentCategoryInfos.get(1).getCategoryId()));
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME2,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId()));
    eventInfos.add(eventService.createEvent(EXISTENT_EVENT_NAME3,
        getFutureDate(), persistentCategoryInfos.get(1).getCategoryId()));
    ...
    /* Call */
    EventInfoBlock eventInfoBlock = eventService.findEvents(null,
        persistentCategoryInfos.get(0).getCategoryId(), true, 0, 2);
  ...
  public void findEventsWithANegativeStartIdexOrCount()
    ...
    /* Call */
    eventService.findEvents(null, persistentCategoryInfos.get(0)
        .getCategoryId(), true, -1, 0);
  ...
  public void testAddBetType() throws InstanceNotFoundException,
    ...
    initializeCategoryInfos();
    initializeEventInfos();
    BetType betType = new BetType(BETTYPE_QUESTION, false, persistentEventInfos
        .get(2));
    List<TypeOption> typeOptions = new ArrayList<>();
    typeOptions.add(new TypeOption(TYPEOPTION_ODD, TYPEOPTION_RESULT1,
        betType));

    /* Call */
    eventService.addBetType(persistentEventInfos.get(2).getEventId(), betType,
        typeOptions);

    EventInfo event = eventInfoDao.find(persistentEventInfos.get(2)
        .getEventId());
  ...
  public void testPickWinnersWithNonExistentBetTypeId()
    ...
    /* Setup */
    initializeCategoryInfos();
    EventInfo event = eventService.createEvent(EXISTENT_CATEGORY_NAME0,
        getFutureDate(), persistentCategoryInfos.get(0).getCategoryId());
    ...
    TypeOption option1 = new TypeOption(TYPEOPTION_ODD, TYPEOPTION_RESULT1,
        betType);
    options.add(option1);
    typeOptionDao.save(option1);
    TypeOption option2 = new TypeOption(TYPEOPTION_ODD, TYPEOPTION_RESULT2,
        betType);
    options.add(option2);
   ...
   */
  @Test
  public void testPickWinners() throws InstanceNotFoundException,
      TypeNotMultipleException, EventDateException, NullEventNameException {
