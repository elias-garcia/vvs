...
public class UserServiceUnitTest {
  ...
  private void initializeUser() {
    userProfile = new UserProfile("user1", "pass", "nombre", "apellido",
        "user@gmail.com");
  }
  ...
  public void testRegisterUserAndFindUserProfile()
    ...
    /* Mock behavior */
    doThrow(InstanceNotFoundException.class).when(userProfileDaoMock)
        .findByLoginName("user1");
    ...
    when(userProfileDaoMock.find(userProfile.getUserProfileId())).thenReturn(
        userProfile);
  ...
  public void testRegisterDuplicatedUser() throws DuplicateInstanceException,
    ...
    /* Mock behavior */
    doThrow(DuplicateInstanceException.class).when(userProfileDaoMock)
        .findByLoginName("user1");

    /* Call Register duplicate user */
    userService.registerUser("user1", "pass", new UserProfileDetails("nombre",
  ...
  public void testLoginWithNonExistentUser() throws IncorrectPasswordException,
    ...
    when(userProfileDaoMock.findByLoginName("user1")).thenThrow(
  ...
  public void testFindNonExistentUser() throws InstanceNotFoundException {
    ...
    when(userProfileDaoMock.find(NON_EXISTENT_USER_PROFILE_ID)).thenThrow(
        InstanceNotFoundException.class);
  ...
  public void testChangePasswordWithIncorrectPassword()
    ...
    /* Call changePassword */
    userService.changePassword(userProfile.getUserProfileId(), "Xpass",
        "Ypass");
  ...
  public void testUpdate() throws InstanceNotFoundException,
    ...
    UserProfile userProfile2 = new UserProfile("use1", "pass", "Xnombre",
        "Xapellido", "Xuser@gmail.com");
