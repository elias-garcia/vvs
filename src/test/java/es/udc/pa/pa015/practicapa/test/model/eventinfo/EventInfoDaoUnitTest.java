...
public class EventInfoDaoUnitTest {
  ...
  public void testFindEventsFilteringWithKeywords() {
    ...
    /* Call */
    List<EventInfo> results = eventInfoDao.findEvents(KEYWORDS, null, true, 0,
        4);
    /* Assertion */
    assertEquals(results, persistentEventInfos);
  }
  ...
  public void testFindEventsFilteringWithCategoryInfo() {
    ...
    /* Call */
    List<EventInfo> results = eventInfoDao.findEvents(null,
        persistentCategoryInfos.get(0).getCategoryId(), true, 0, 4);
    /* Assertion */
    assertEquals(results, persistentEventInfos);
  }
