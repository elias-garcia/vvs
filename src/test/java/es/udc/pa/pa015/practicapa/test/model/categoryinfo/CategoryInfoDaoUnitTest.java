...
public class CategoryInfoDaoUnitTest {
   ...
   *           It throw out when the category doesn't exist
   */
  @Test
   ...
   * PR-UN-001.
   * @throws InstanceNotFoundException
   *           It thrown out when the category doesn't exit.
   */
  @Test(expected = InstanceNotFoundException.class)
  public void testFindAndSaveGenericDaoWithANonExistentCategoryId()
      throws InstanceNotFoundException {
    /* Setup */
    CategoryInfo categoryInfo = newCategory();
    /* Call */
   ...
   */
  @Test
  public void testRemoveAndSaveAndFindGenericDao()
      throws InstanceNotFoundException {
    /* Setup */
   ...
   */
  @Test(expected = InstanceNotFoundException.class)
  public void testRemoveAndSaveAndFindGenericDaoWithANonExistentCategoryId()
      throws InstanceNotFoundException {
    /* Setup */
    CategoryInfo categoryInfo = newCategory();
    /* Call */
  ...
  public void testSaveUddateDataGenericDao() throws InstanceNotFoundException {
    ...
    categoryInfoDao.save(categoryInfo);
    CategoryInfo foundCategoryInfo = categoryInfoDao.find(categoryInfo
        .getCategoryId());
    /* Assertion */
