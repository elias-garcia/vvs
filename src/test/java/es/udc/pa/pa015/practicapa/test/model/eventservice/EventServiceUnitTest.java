...
public class EventServiceUnitTest {
  ...
  private void initializeBetTypes() {
    persistentBetTypes.add(new BetType(BETTYPE_QUESTION, false,
        persistentEventInfos.get(0)));
  }

  private void initializeTypeOptions() {
    persistentTypeOptions.add(new TypeOption(TYPEOPTION_ODD, TYPEOPTION_RESULT,
        persistentBetTypes.get(0)));
  }
  ...
  public void testCreateEvent() throws InstanceNotFoundException,
    ...
    /* Mock behavior */
    when(categoryInfoDaoMock.find(1L)).thenReturn(persistentCategoryInfos.get(
        0));
   ...
   *           It thrown out when the catefory doesnt' exist
   */
   ...
   * PR-UN-019.
   * @throws InstanceNotFoundException
   *           It thrown out when the category doesn't exist
   */
  @SuppressWarnings("unchecked")
   ...
   *           This method thrown out when the starindex or count are not
   *           correct
   */
  @Test
  public void findEventsFilteringWithStartIndexAndCount1()
    ...
    /* Mock behavior */
    when(eventInfoDaoMock.findEvents(null, null, true, 0, 4)).thenReturn(
        persistentEventInfos);

    /* Call */
    EventInfoBlock foundEventInfoBlock = eventService.findEvents(null, null,
        true, 0, 4);
   ...
   *           This method thrown out when there's not type options assigned
   * @throws DuplicatedResultTypeOptionsException
   *           This method thrown out when the results are duplicated
   */
  @Test
  public void testAddBetType() throws InstanceNotFoundException,
    ...
    /* Call */
    eventService.addBetType(1L, persistentBetTypes.get(0),
        persistentTypeOptions);
  ...
  public void testAddBetTypeWithNonExistentEnventInfoId()
    ...
    /* Call */
    eventService.addBetType(NON_EXISTENT_ID, persistentBetTypes.get(0),
        persistentTypeOptions);
  ...
  public void testFindAllCategories() throws InstanceNotFoundException {
    ...
    /* Mock behavior */
    when(categoryInfoDaoMock.findAllCategories()).thenReturn(
        persistentCategoryInfos);
