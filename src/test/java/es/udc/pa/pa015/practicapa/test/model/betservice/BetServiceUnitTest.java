...
public class BetServiceUnitTest {
	...
	BetType betTypeDemo;
	TypeOption typeOptionDemo1, typeOptionDemo2, typeOptionDemo3;
	BetInfo betInfoDemo1, betInfoDemo2, betInfoDemo3;

	private void initializeUserProfile() {
		userProfileDemo = new UserProfile("user", "demo", "Demo", "User", "user@demo.com");
	}
	...
	private void initializeEventInfo() {
		...
		eventInfoDemo = new EventInfo("Deportivo de la Coruña - Celta de Vigo", date, categoryInfoDemo);
	}
	...
	private void initializeTypeOptions() {
		typeOptionDemo1 = new TypeOption(5.00, "Deportivo de la Coruña", betTypeDemo);
	...
	private void initializeBets() {
		betInfoDemo1 = new BetInfo(Calendar.getInstance(), 10.00, userProfileDemo, typeOptionDemo1);
		betInfoDemo2 = new BetInfo(Calendar.getInstance(), 10.00, userProfileDemo, typeOptionDemo2);
		betInfoDemo3 = new BetInfo(Calendar.getInstance(), 10.00, userProfileDemo, typeOptionDemo3);
	}
	...
	public void createBet() throws InstanceNotFoundException {
		...
		BetInfo testBet = betService.createBet(1L, 1L, 10.00);

		when(betInfoDaoMock.find(1L)).thenReturn(testBet);

		assertEquals(testBet, betInfoDaoMock.find(1L));
	 ...
	 */
	@Test(expected = InstanceNotFoundException.class)
	public void createBetNonExistingTypeOption() throws InstanceNotFoundException {

		initializeUserProfile();

		when(userProfileDaoMock.find(1L)).thenReturn(userProfileDemo);
		when(typeOptionDaoMock.find(-1L)).thenThrow(InstanceNotFoundException.class);
