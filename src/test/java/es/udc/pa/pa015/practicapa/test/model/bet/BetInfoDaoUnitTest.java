...
public class BetInfoDaoUnitTest {
  ...
  private void initializeUser() {
    userWithBets = new UserProfile(USER_WITH_BETS_LOGINAME, "pass", "nombre",
        "apellido", "user@gmail.com");
    userNoWithBets = new UserProfile(USER_WITHOUT_BETS_LOGINAME, "pass",
        "nombre", "apellido", "user@gmail.com");
  ...
  private void initializeEvent() {
    Calendar date = new GregorianCalendar(2010, Calendar.FEBRUARY, 22, 23, 11,
        44);
  ...
  public void testBetsByUserIdWithUserWithBets() {
    ...
    /* Call */
    betsFound = betInfoDao.findBetsByUserId(userWithBets.getUserProfileId(),
        STARTINDEX, COUNT);
  ...
  public void testBetsByUserIdWithUserNoWithBets() {
    ...
    /* Call */
    betsFound = betInfoDao.findBetsByUserId(userNoWithBets.getUserProfileId(),
        STARTINDEX, COUNT);
