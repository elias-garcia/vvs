...
public final class jcrypt {
                  ...
                  0x04021008, 0x04121008, 0x04021108, 0x04121108, }, {
                      ...
                      0x20101004, 0x30101004, 0x20111004, 0x30111004, }, {
                          ...
                          0x02020401, 0x0A020401, 0x02020409, 0x0A020409, }, {
                              /*
                               * for D bits (numbered as per FIPS 46) 16 17 18
                               * 19 20 21
                               */
  ...
  private static int[] des_set_key(byte key[]) {
    ...
    for (int i = 0; i < ITERATIONS; i++) {
      ...
      s = skb[0][(c) & 0x3f] | skb[1][((c >>> 6) & 0x03) | ((c >>> 7) & 0x3c)]
          ...
          | skb[3][((c >>> 20) & 0x01) | ((c >>> 21) & 0x06) | ((c >>> 22)
              & 0x38)];

      t = skb[4][(d) & 0x3f] | skb[5][((d >>> 7) & 0x03) | ((d >>> 8) & 0x3c)]
          | skb[6][(d >>> 15) & 0x3f] | skb[7][((d >>> 21) & 0x0f) | ((d >>> 22)
              & 0x30)];
  ...
  /**
   * This method encrypt a passed string.
   * @param salt
   *          String to encrypt
   * @param original
   *          String to encrypt
  ...
  public static void main(String args[]) {
    if (args.length >= 2) {
      System.out.println("[" + args[0] + "] [" + args[1] + "] => [" + jcrypt
          .crypt(args[0], args[1]) + "]");
    }
  }
}
