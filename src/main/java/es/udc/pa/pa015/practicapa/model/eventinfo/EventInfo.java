...
public class EventInfo {
	 ...
	 */
	public EventInfo(final String eventNameParam, final Calendar eventDateParam, final CategoryInfo categoryParam) {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "EventInfoIdGenerator")
